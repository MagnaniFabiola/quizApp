...
export default function Professor() {
  ...
  function saveQuiz() {
    ...
    alert("Quiz saved locally (demo only).");
  }
    ...
    <div className="min-h-screen bg-bg text-text">
      ...
      <div className="max-w-6xl mx-auto px-8 py-6">
        ...
        <div className="flex flex-wrap gap-6 mb-12">
          <ClassCard title="HCI" />
          <ClassCard title="Database" />
        </div>

        {/* Create Quiz */}
        <h2 className="text-xl font-semibold mb-4">CREATING QUIZ FOR HCI</h2>
  ...
  return (
    <div className="bg-surface rounded-xl p-6 w-56 border border-border">
      ...
      <div className="flex justify-center">
        <button className="bg-brand text-white px-6 py-2 rounded-lg hover:bg-opacity-90 transition-colors">
          Create Quiz
        </button>
      </div>
    </div>
